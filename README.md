This is a [Next.js](https://nextjs.org/) project that talks to serverless APIs deployed over AWS Lambda with serverless framework. View the live preview [here](https://photo-gallery-frontend-eta.vercel.app/)
